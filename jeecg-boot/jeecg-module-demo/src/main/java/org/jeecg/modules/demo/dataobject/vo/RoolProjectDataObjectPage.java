package org.jeecg.modules.demo.dataobject.vo;
...
public class RoolProjectDataObjectPage {
	...
	@ExcelCollection(name="字段")
	@ApiModelProperty(value = "字段")
	private List<RoolDataObject> roolDataObjectList;
	@ExcelCollection(name="源代码")
	@ApiModelProperty(value = "源代码")
	private List<RoolDataObjectCode> roolDataObjectCodeList;

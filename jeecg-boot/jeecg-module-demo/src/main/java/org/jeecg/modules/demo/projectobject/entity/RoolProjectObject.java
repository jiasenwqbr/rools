package org.jeecg.modules.demo.projectobject.entity;
...
@ApiModel(value="rool_project_object对象", description="项目对象")
public class RoolProjectObject implements Serializable {

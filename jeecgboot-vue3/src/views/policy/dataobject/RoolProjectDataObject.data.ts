...
export const searchFormSchema: FormSchema[] = [
  ...
  },
  {
    ...
    componentProps: {
      options: [{ label: '数据对象JavaBean', value: '000' }],
    },
    //colProps: {span: 6},
  },
];
...
//子表单数据
export const roolDataObjectCodeFormSchema: FormSchema[] = [
  {
    label: '源代码',
    field: 'code',
...
//子表表格配置
export const roolDataObjectColumns: JVxeColumn[] = [
  {
    title: '标识符',
    key: 'identifier',
...
export const superQuerySchema = {
  ...
  roolDataObject: {
    ...
    view: 'table',
    fields: {
      identifier: { title: '标识符', order: 0, view: 'text', type: 'string' },
      tag: { title: '标签', order: 1, view: 'text', type: 'string' },
      colType: { title: '类型', order: 2, view: 'text', type: 'string' },
    },
  },
  roolDataObjectCode: {
    title: '源代码',
    view: 'table',
    fields: {
      code: { title: '源代码', order: 0, view: 'textarea', type: 'string' },
    },
  },
};

...
//子表单数据
export const roolDataDrlCodeFormSchema: FormSchema[] = [
  {
    label: '源代码',
    field: 'drlCode',
...
export const superQuerySchema = {
  ...
  roolDataDrlCode: {
    ...
    view: 'table',
    fields: {
      projectDataId: { title: '项目对象', order: 0, view: 'text', type: 'string' },
      drlCode: { title: '源代码', order: 1, view: 'JMarkdownEditor', type: 'string' },
    },
  },
};

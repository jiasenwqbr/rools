...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    component: 'JDictSelectTag',
    componentProps: {
      dictCode: 'rool_container,container_name,id',
    },
  },
  {
    label: '描述',
...
export const superQuerySchema = {
  ...
  serverId: {
    ...
    view: 'list',
    type: 'string',
    dictTable: 'rool_server_template',
    dictCode: 'id',
    dictText: 'templeate_name',
  },
  containerId: { title: '容器', order: 2, view: 'list', type: 'string', dictTable: 'rool_container', dictCode: 'id', dictText: 'container_name' },

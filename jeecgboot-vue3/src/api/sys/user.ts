...
import { LoginParams, LoginResultModel, GetUserInfoModel, SsoLoginParams } from './model/userModel';
...
enum Api {
  ...
  // sso登录
  getSsoLogin = '/sys/thirdLogin/getSsoLogin',
}
...
export function loginSsoApi(params: SsoLoginParams, mode: ErrorMessageMode = 'modal') {
  return defHttp.post<LoginResultModel>({ url: Api.getSsoLogin, params }, { errorMessageMode: mode });
}
